...
## **Descrição:**
O projeto tem como objetivo a análise do tráfego aério brasileiro com os dados disponibilizados por [Alvaro](https://github.com/alvarofpp/dataset-flights-brazil) e seus aeroportos, onde os relacionados à análise de redes devem ser aplicados.
